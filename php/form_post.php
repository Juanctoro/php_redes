...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  <div class="max-w-md w-full bg-white rounded-xl shadow-md overflow-hidden p-8">
    <h1 class="text-2xl font-bold text-center mb-6">Formulario usando POST</h1>
    <form action="welcome.php" method="POST" class="space-y-4">
      <div>
      ...
      <div>
        <input type="submit" value="Enviar" class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition-colors cursor-pointer">
      </div>
    </form>
